 ...
 * @method self setDeliveryIdRef(array<string, mixed>|\Naugrim\OpenTrans\Nodes\DeliveryIdRef $deliveryIdRef)
 * @method \Naugrim\OpenTrans\Nodes\DeliveryIdRef getDeliveryIdRef()
 * @method self setFinalDeliveryIdRef(null|array<string, mixed>|\Naugrim\OpenTrans\Nodes\FinalDeliveryIdRef $finalDeliveryIdRef)
 * @method \Naugrim\OpenTrans\Nodes\FinalDeliveryIdRef|null getFinalDeliveryIdRef()
 * @method self setDelivererIdRef(null|array<string, mixed>|\Naugrim\OpenTrans\Nodes\DelivererIdRef $delivererIdRef)
