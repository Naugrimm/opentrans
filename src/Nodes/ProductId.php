 ...
 * @method self setSupplierPid(null|array<string, mixed>|\Naugrim\BMEcat\Nodes\SupplierPid $supplierPid)
 ...
 * @method self setInternationalPid(\Naugrim\BMEcat\Nodes\InternationalPid[]|array<string, mixed> $internationalPid)
 * @method \Naugrim\BMEcat\Nodes\InternationalPid[] getInternationalPid()
 * @method self setBuyerPid(\Naugrim\BMEcat\Nodes\BuyerPid[]|array<string, mixed> $buyerPid)
 * @method \Naugrim\BMEcat\Nodes\BuyerPid[] getBuyerPid()
 ...
 * @method self setManufacturerInfo(null|array<string, mixed>|\Naugrim\OpenTrans\Nodes\ManufacturerInfo $manufacturerInfo)
