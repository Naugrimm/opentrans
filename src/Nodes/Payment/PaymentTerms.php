 ...
 * @method self setTerms(\Naugrim\OpenTrans\Nodes\Payment\PaymentTerm[]|array<string, mixed> $terms)
 * @method \Naugrim\OpenTrans\Nodes\Payment\PaymentTerm[] getTerms()
 * @method self setValueDate(string|null $valueDate)
 * @method string|null getValueDate()
 * @method self setTimeForPayment(null|array<string, mixed>|\Naugrim\OpenTrans\Nodes\TimeForPayment $timeForPayment)
