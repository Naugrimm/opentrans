 ...
 * @method bool|null getDebit()
 * @method self setCheck(bool|null $check)
 * @method bool|null getCheck()
 * @method self setCentralRegulation(bool|null $centralRegulation)
 * @method bool|null getCentralRegulation()
 * @method self setPaymentTerms(null|array|\Naugrim\OpenTrans\Nodes\Payment\PaymentTerms $paymentTerms)
