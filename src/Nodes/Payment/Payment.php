 ...
 * @method self setAccounts(\Naugrim\OpenTrans\Nodes\Account[]|array<string, mixed> $accounts)
 * @method \Naugrim\OpenTrans\Nodes\Account[] getAccounts()
 * @method self setCentralRegulation(bool|null $centralRegulation)
 * @method bool|null getCentralRegulation()
 * @method self setPaymentTerms(null|array<string, mixed>|\Naugrim\OpenTrans\Nodes\Payment\PaymentTerms $paymentTerms)
 * @method \Naugrim\OpenTrans\Nodes\Payment\PaymentTerms|null getPaymentTerms()
 */
