 ...
 * @method self setRole(\Naugrim\BMEcat\Nodes\Contact\Role[]|array<string, mixed> $role)
 ...
 * @method self setEmails(array<string, mixed>|\Naugrim\OpenTrans\Nodes\Emails $emails)
