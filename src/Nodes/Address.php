 ...
 * @method self setContactDetails(\Naugrim\OpenTrans\Nodes\Contact\Details[]|array<string, mixed> $contactDetails)
 * @method \Naugrim\OpenTrans\Nodes\Contact\Details[] getContactDetails()
 ...
 * @method self setPhone(\Naugrim\BMEcat\Nodes\Phone[]|array<string, mixed> $phone)
 * @method \Naugrim\BMEcat\Nodes\Phone[] getPhone()
 * @method self setFax(\Naugrim\BMEcat\Nodes\Fax[]|array<string, mixed> $fax)
 * @method \Naugrim\BMEcat\Nodes\Fax[] getFax()
 * @method self setEmails(string[] $emails)
 * @method string[] getEmails()
 * @method self setPublicKey(\Naugrim\BMEcat\Nodes\Crypto\PublicKey[]|array<string, mixed> $publicKey)
 * @method \Naugrim\BMEcat\Nodes\Crypto\PublicKey[] getPublicKey()
